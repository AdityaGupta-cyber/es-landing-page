...
export default function Bloomscape() {
  ...
  return (
    <div
      className={`${BlackMango.className}  relative z-0 top-0 min-h-screen w-full bg-[#f8f7f4] text-[#433631] flex flex-col p3`}
    >
        ...
        <div className="w-full mx-auto flex flex-col items-center lg:flex-row lg:mt-[10vh] xl:mt-[20vh] justify-between gap-44">
          <div className="w-full mb-8 lg:mb-0">
            <AnimatePresence>
              {" "}
              <motion.div
                className="text-4xl break-all overflow-hidden sm:text-5xl lg:text-6xl xl:text-8xl mb-4 tracking-wide z-10 relative min-w-fit max-w-[300px]"
                animate={controls3}
